...
* 3.Execute the a.out file to produce vcd file.

```
./a.out
```

![image](https://github.com/Chentianyu-Juventus/VSD/assets/149767608/689642d6-968b-49ed-b429-d16e84a5446e)
...
* 1.Use following command to install gtkwave on Ubuntu machine.

```
sudo apt install gtkwave
```

* 2.Run following command to view the waveform.

```
gtkwave test_bench.vcd
```

![image](https://github.com/Chentianyu-Juventus/VSD/assets/149767608/1d1469de-c083-430c-bebe-c4aa7fb0321b)


### sky130 libraries

sky130 pdk library is used for standard cell mapping during synthesis. The design gets mapped to standard cell definitions present in "sky130_fd_sc_hd__tt_025C_1v80.lib" library. 
...
* 1.Use following command to install yosys on Ubuntu machine.

```
sudo apt install yosys
```

* 2.Invoke yosys by running following command.
